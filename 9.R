...
handle <-
  getCurlHandle(
    httpheader = list(
      ...
      Cookie = 'JSESSIONID=03E583EF37759464669E6EBDA76994C6; theme=theme_base; token=c37223fe710d5093af1b653c398052c5; userId=s00580; userType=CBUSER; userName=%E6%9D%8E%E9%95%BF%E5%85%B4',
