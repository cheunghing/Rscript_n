...
handle <-
  getCurlHandle(
    httpheader = list(
      ...
      Cookie = 'JSESSIONID=DD327E907043D8F47C3097CE0F8CBF24; theme=theme_base; userName=%E6%9D%8E%E9%95%BF%E5%85%B4; token=2819b3c20fcbadfea58b5f4a0b8c66fd; userId=s00580; userType=CBUSER',
