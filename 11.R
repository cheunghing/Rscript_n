...
handle <-
  getCurlHandle(
    httpheader = list(
      ...
      Cookie = 'JSESSIONID=83BB5BD6046D297A8680446C757FA1E6; theme=theme_base; token=a9acde0ff6754a2f5ee6d240323af7c0; userId=s00580; userType=CBUSER; userName=%E6%9D%8E%E9%95%BF%E5%85%B4',
